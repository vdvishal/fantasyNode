 ...
 */
 ...
 const profile = async (req,res) => {
    ...
    .select('email phone fullName userName wallet documentSubmitted verifiedKYC stats bankAccountId vpa beneficiaryId refCode messageCount facebookId activated profilePic refLink')
